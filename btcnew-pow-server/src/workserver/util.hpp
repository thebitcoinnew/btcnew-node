...
inline double to_multiplier (btcnew_pow_server::u128 const difficulty_a, btcnew_pow_server::u128 const base_difficulty_a)
{
...
inline btcnew_pow_server::u128 from_multiplier (double const multiplier_a, btcnew_pow_server::u128 const base_difficulty_a)
{
