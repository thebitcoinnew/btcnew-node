...
btcnew::error btcnew::rocksdb_config::serialize_toml (btcnew::tomlconfig & toml) const
{
...
btcnew::error btcnew::rocksdb_config::deserialize_toml (btcnew::tomlconfig & toml)
{
