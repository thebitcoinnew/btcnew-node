...
btcnew::error btcnew::diagnostics_config::serialize_json (btcnew::jsonconfig & json) const
{
...
btcnew::error btcnew::diagnostics_config::deserialize_json (btcnew::jsonconfig & json)
{
...
btcnew::error btcnew::diagnostics_config::serialize_toml (btcnew::tomlconfig & toml) const
{
	btcnew::tomlconfig txn_tracking_l;
...
btcnew::error btcnew::diagnostics_config::deserialize_toml (btcnew::tomlconfig & toml)
{
