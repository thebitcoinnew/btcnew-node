...
btcnew::error btcnew::stat_config::deserialize_json (btcnew::jsonconfig & json)
{
...
btcnew::error btcnew::stat_config::deserialize_toml (btcnew::tomlconfig & toml)
{
...
btcnew::error btcnew::stat_config::serialize_toml (btcnew::tomlconfig & toml) const
{
	btcnew::tomlconfig sampling_l;
...
std::string btcnew::stat_log_sink::tm_to_string (tm & tm)
{
...
class json_writer : public btcnew::stat_log_sink
{
...
class file_writer : public btcnew::stat_log_sink
{
public:
	std::ofstream log;
	std::string filename;
...
btcnew::stat::stat (btcnew::stat_config config) :
config (config)
{
}

std::shared_ptr<btcnew::stat_entry> btcnew::stat::get_entry (uint32_t key)
{
	return get_entry (key, config.interval, config.capacity);
}

std::shared_ptr<btcnew::stat_entry> btcnew::stat::get_entry (uint32_t key, size_t interval, size_t capacity)
{
	btcnew::unique_lock<std::mutex> lock (stat_mutex);
	return get_entry_impl (key, interval, capacity);
}

std::shared_ptr<btcnew::stat_entry> btcnew::stat::get_entry_impl (uint32_t key, size_t interval, size_t capacity)
{
	std::shared_ptr<btcnew::stat_entry> res;
	auto entry = entries.find (key);
	if (entry == entries.end ())
	{
		res = entries.insert (std::make_pair (key, std::make_shared<btcnew::stat_entry> (capacity, interval))).first->second;
	}
	else
	{
		res = entry->second;
...
std::unique_ptr<btcnew::stat_log_sink> btcnew::stat::log_sink_json () const
{
	return std::make_unique<json_writer> ();
}

void btcnew::stat::log_counters (stat_log_sink & sink)
{
	btcnew::unique_lock<std::mutex> lock (stat_mutex);
	log_counters_impl (sink);
}

void btcnew::stat::log_counters_impl (stat_log_sink & sink)
{
	sink.begin ();
...
void btcnew::stat::log_samples (stat_log_sink & sink)
{
	btcnew::unique_lock<std::mutex> lock (stat_mutex);
	log_samples_impl (sink);
}

void btcnew::stat::log_samples_impl (stat_log_sink & sink)
{
	sink.begin ();
	if (sink.entries () >= config.log_rotation_count)
	{
...
void btcnew::stat::update (uint32_t key_a, uint64_t value)
{
...
std::chrono::seconds btcnew::stat::last_reset ()
{
	btcnew::unique_lock<std::mutex> lock (stat_mutex);
	auto now (std::chrono::steady_clock::now ());
...
void btcnew::stat::stop ()
{
	btcnew::lock_guard<std::mutex> guard (stat_mutex);
	stopped = true;
}

void btcnew::stat::clear ()
{
	btcnew::unique_lock<std::mutex> lock (stat_mutex);
	entries.clear ();
...
std::string btcnew::stat::type_to_string (uint32_t key)
{
	auto type = static_cast<stat::type> (key >> 16 & 0x000000ff);
	std::string res;
	switch (type)
	{
		case btcnew::stat::type::ipc:
			res = "ipc";
			break;
		case btcnew::stat::type::block:
			res = "block";
			break;
		case btcnew::stat::type::bootstrap:
			res = "bootstrap";
			break;
		case btcnew::stat::type::error:
			res = "error";
			break;
		case btcnew::stat::type::http_callback:
			res = "http_callback";
			break;
		case btcnew::stat::type::ledger:
			res = "ledger";
			break;
		case btcnew::stat::type::tcp:
			res = "tcp";
			break;
		case btcnew::stat::type::udp:
			res = "udp";
			break;
		case btcnew::stat::type::peering:
			res = "peering";
			break;
		case btcnew::stat::type::rollback:
			res = "rollback";
			break;
		case btcnew::stat::type::traffic_udp:
			res = "traffic_udp";
			break;
		case btcnew::stat::type::traffic_tcp:
			res = "traffic_tcp";
			break;
		case btcnew::stat::type::vote:
			res = "vote";
			break;
		case btcnew::stat::type::election:
			res = "election";
			break;
		case btcnew::stat::type::message:
			res = "message";
			break;
		case btcnew::stat::type::observer:
			res = "observer";
			break;
		case btcnew::stat::type::confirmation_height:
			res = "confirmation_height";
			break;
		case btcnew::stat::type::drop:
			res = "drop";
	}
	return res;
}

std::string btcnew::stat::detail_to_string (uint32_t key)
{
	auto detail = static_cast<stat::detail> (key >> 8 & 0x000000ff);
	std::string res;
	switch (detail)
	{
		case btcnew::stat::detail::all:
			res = "all";
			break;
		case btcnew::stat::detail::bad_sender:
			res = "bad_sender";
			break;
		case btcnew::stat::detail::bulk_pull:
			res = "bulk_pull";
			break;
		case btcnew::stat::detail::bulk_pull_account:
			res = "bulk_pull_account";
			break;
		case btcnew::stat::detail::bulk_pull_deserialize_receive_block:
			res = "bulk_pull_deserialize_receive_block";
			break;
		case btcnew::stat::detail::bulk_pull_error_starting_request:
			res = "bulk_pull_error_starting_request";
			break;
		case btcnew::stat::detail::bulk_pull_failed_account:
			res = "bulk_pull_failed_account";
			break;
		case btcnew::stat::detail::bulk_pull_receive_block_failure:
			res = "bulk_pull_receive_block_failure";
			break;
		case btcnew::stat::detail::bulk_pull_request_failure:
			res = "bulk_pull_request_failure";
			break;
		case btcnew::stat::detail::bulk_push:
			res = "bulk_push";
			break;
		case btcnew::stat::detail::observer_confirmation_active_quorum:
			res = "observer_confirmation_active_quorum";
			break;
		case btcnew::stat::detail::observer_confirmation_active_conf_height:
			res = "observer_confirmation_active_conf_height";
			break;
		case btcnew::stat::detail::observer_confirmation_inactive:
			res = "observer_confirmation_inactive";
			break;
		case btcnew::stat::detail::error_socket_close:
			res = "error_socket_close";
			break;
		case btcnew::stat::detail::change:
			res = "change";
			break;
		case btcnew::stat::detail::confirm_ack:
			res = "confirm_ack";
			break;
		case btcnew::stat::detail::node_id_handshake:
			res = "node_id_handshake";
			break;
		case btcnew::stat::detail::confirm_req:
			res = "confirm_req";
			break;
		case btcnew::stat::detail::fork:
			res = "fork";
			break;
		case btcnew::stat::detail::frontier_confirmation_failed:
			res = "frontier_confirmation_failed";
			break;
		case btcnew::stat::detail::frontier_confirmation_successful:
			res = "frontier_confirmation_successful";
			break;
		case btcnew::stat::detail::frontier_req:
			res = "frontier_req";
			break;
		case btcnew::stat::detail::handshake:
			res = "handshake";
			break;
		case btcnew::stat::detail::http_callback:
			res = "http_callback";
			break;
		case btcnew::stat::detail::initiate:
			res = "initiate";
			break;
		case btcnew::stat::detail::initiate_lazy:
			res = "initiate_lazy";
			break;
		case btcnew::stat::detail::initiate_wallet_lazy:
			res = "initiate_wallet_lazy";
			break;
		case btcnew::stat::detail::insufficient_work:
			res = "insufficient_work";
			break;
		case btcnew::stat::detail::invocations:
			res = "invocations";
			break;
		case btcnew::stat::detail::keepalive:
			res = "keepalive";
			break;
		case btcnew::stat::detail::open:
			res = "open";
			break;
		case btcnew::stat::detail::publish:
			res = "publish";
			break;
		case btcnew::stat::detail::receive:
			res = "receive";
			break;
		case btcnew::stat::detail::republish_vote:
			res = "republish_vote";
			break;
		case btcnew::stat::detail::send:
			res = "send";
			break;
		case btcnew::stat::detail::state_block:
			res = "state_block";
			break;
		case btcnew::stat::detail::epoch_block:
			res = "epoch_block";
			break;
		case btcnew::stat::detail::vote_valid:
			res = "vote_valid";
			break;
		case btcnew::stat::detail::vote_replay:
			res = "vote_replay";
			break;
		case btcnew::stat::detail::vote_invalid:
			res = "vote_invalid";
			break;
		case btcnew::stat::detail::vote_overflow:
			res = "vote_overflow";
			break;
		case btcnew::stat::detail::vote_new:
			res = "vote_new";
			break;
		case btcnew::stat::detail::vote_cached:
			res = "vote_cached";
			break;
		case btcnew::stat::detail::late_block:
			res = "late_block";
			break;
		case btcnew::stat::detail::late_block_seconds:
			res = "late_block_seconds";
			break;
		case btcnew::stat::detail::blocking:
			res = "blocking";
			break;
		case btcnew::stat::detail::overflow:
			res = "overflow";
			break;
		case btcnew::stat::detail::tcp_accept_success:
			res = "accept_success";
			break;
		case btcnew::stat::detail::tcp_accept_failure:
			res = "accept_failure";
			break;
		case btcnew::stat::detail::tcp_write_drop:
			res = "tcp_write_drop";
			break;
		case btcnew::stat::detail::unreachable_host:
			res = "unreachable_host";
			break;
		case btcnew::stat::detail::invalid_magic:
			res = "invalid_magic";
			break;
		case btcnew::stat::detail::invalid_network:
			res = "invalid_network";
			break;
		case btcnew::stat::detail::invalid_header:
			res = "invalid_header";
			break;
		case btcnew::stat::detail::invalid_message_type:
			res = "invalid_message_type";
			break;
		case btcnew::stat::detail::invalid_keepalive_message:
			res = "invalid_keepalive_message";
			break;
		case btcnew::stat::detail::invalid_publish_message:
			res = "invalid_publish_message";
			break;
		case btcnew::stat::detail::invalid_confirm_req_message:
			res = "invalid_confirm_req_message";
			break;
		case btcnew::stat::detail::invalid_confirm_ack_message:
			res = "invalid_confirm_ack_message";
			break;
		case btcnew::stat::detail::invalid_node_id_handshake_message:
			res = "invalid_node_id_handshake_message";
			break;
		case btcnew::stat::detail::outdated_version:
			res = "outdated_version";
			break;
		case btcnew::stat::detail::invalid_block:
			res = "invalid_block";
			break;
		case btcnew::stat::detail::blocks_confirmed:
			res = "blocks_confirmed";
	}
	return res;
}

std::string btcnew::stat::dir_to_string (uint32_t key)
{
	auto dir = static_cast<stat::dir> (key & 0x000000ff);
	std::string res;
	switch (dir)
	{
		case btcnew::stat::dir::in:
			res = "in";
			break;
		case btcnew::stat::dir::out:
			res = "out";
			break;
	}
	return res;
