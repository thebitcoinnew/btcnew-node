...
public:
	...
	QPushButton * back;
	btcnew_qt::wallet & wallet;
};
class advanced_actions
{
public:
	advanced_actions (btcnew_qt::wallet &);
	QWidget * window;
	QVBoxLayout * layout;
	...
	QRadioButton * mbtcnew_unit;
	QRadioButton * kbtcnew_unit;
	QRadioButton * btcnew_unit;
...
{
public:
	block_creation (btcnew_qt::wallet &);
	void deactivate_all ();
	void activate_send ();
...
{
public:
	self_pane (btcnew_qt::wallet &, btcnew::account const &);
	void set_balance_text (std::pair<btcnew::uint128_t, btcnew::uint128_t>);
	QWidget * window;
	QVBoxLayout * layout;
...
{
public:
	history (btcnew::ledger &, btcnew::account const &, btcnew_qt::wallet &);
	void refresh ();
	QWidget * window;
	QVBoxLayout * layout;
	QStandardItemModel * model;
	...
	btcnew::account const & account;
	btcnew_qt::wallet & wallet;
};
class block_viewer
{
public:
	block_viewer (btcnew_qt::wallet &);
	void rebroadcast_action (btcnew::block_hash const &);
	QWidget * window;
	QVBoxLayout * layout;
	QLabel * hash_label;
	QLineEdit * hash;
...
{
public:
	account_viewer (btcnew_qt::wallet &);
	QWidget * window;
	QVBoxLayout * layout;
	QLabel * account_label;
...
{
public:
	status (btcnew_qt::wallet &);
	void erase (btcnew_qt::status_types);
	void insert (btcnew_qt::status_types);
	void set_text ();
	std::string text ();
	std::string color ();
	std::set<btcnew_qt::status_types> active;
	btcnew_qt::wallet & wallet;
};
class wallet : public std::enable_shared_from_this<btcnew_qt::wallet>
{
public:
	wallet (QApplication &, btcnew_qt::eventloop_processor &, btcnew::node &, std::shared_ptr<btcnew::wallet>, btcnew::account &);
	void start ();
	void refresh ();
	void update_connected ();
	void empty_password ();
	void change_rendering_ratio (btcnew::uint128_t const &);
	std::string format_balance (btcnew::uint128_t const &) const;
	btcnew::uint128_t rendering_ratio;
	btcnew::node & node;
	std::shared_ptr<btcnew::wallet> wallet_m;
	btcnew::account & account;
	btcnew_qt::eventloop_processor & processor;
	btcnew_qt::history history;
	btcnew_qt::accounts accounts;
	btcnew_qt::self_pane self;
	btcnew_qt::settings settings;
	btcnew_qt::advanced_actions advanced;
	btcnew_qt::block_creation block_creation;
	btcnew_qt::block_entry block_entry;
	btcnew_qt::block_viewer block_viewer;
	btcnew_qt::account_viewer account_viewer;
	btcnew_qt::stats_viewer stats_viewer;
	btcnew_qt::import import;
	...
	btcnew_qt::status active_status;
	void pop_main_stack ();
