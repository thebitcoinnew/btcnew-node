...
bool btcnew::rpc_secure::on_verify_certificate (bool preverified, boost::asio::ssl::verify_context & ctx)
{
...
void btcnew::rpc_secure::load_certs (boost::asio::ssl::context & context_a)
{
...
btcnew::rpc_secure::rpc_secure (boost::asio::io_service & service_a, btcnew::rpc_config const & config_a, btcnew::rpc_handler_interface & rpc_handler_interface_a) :
...
void btcnew::rpc_secure::accept ()
{
	auto connection (std::make_shared<btcnew::rpc_connection_secure> (config, io_ctx, logger, rpc_handler_interface, this->ssl_context));
