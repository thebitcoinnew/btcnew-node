...
btcnew::rpc_handler::rpc_handler (btcnew::rpc_config const & rpc_config, std::string const & body_a, std::string const & request_id_a, std::function<void (std::string const &)> const & response_a, btcnew::rpc_handler_interface & rpc_handler_interface_a, btcnew::logger_mt & logger) :
body (body_a),
...
void btcnew::rpc_handler::process_request ()
{
	try
	{
		...
		else
		{
			...
			std::error_code rpc_control_disabled_ec = btcnew::error_rpc::rpc_control_disabled;
