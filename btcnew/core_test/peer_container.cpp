...
TEST (peer_container, empty_peers)
{
	...
	btcnew::network & network (system.nodes[0]->network);
...
TEST (peer_container, no_recontact)
{
	...
	btcnew::endpoint endpoint1 (boost::asio::ip::address_v6::loopback (), 10000);
	ASSERT_EQ (0, network.size ());
	network.channel_observer = [&observed_peer] (std::shared_ptr<btcnew::transport::channel>) { ++observed_peer; };
...
TEST (peer_container, reserved_peers_no_contact)
{
	...
	ASSERT_EQ (nullptr, channels.insert (btcnew::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0x00000001)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (btcnew::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xc0000201)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (btcnew::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xc6336401)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (btcnew::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xcb007101)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (btcnew::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xe9fc0001)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (btcnew::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xf0000001)), 10000), 0));
	ASSERT_EQ (nullptr, channels.insert (btcnew::endpoint (boost::asio::ip::address_v6::v4_mapped (boost::asio::ip::address_v4 (0xffffffff)), 10000), 0));
...
TEST (peer_container, split)
{
	...
	btcnew::endpoint endpoint1 (boost::asio::ip::address_v6::loopback (), 100);
	btcnew::endpoint endpoint2 (boost::asio::ip::address_v6::loopback (), 101);
...
{
	btcnew::system system (24000, 1);
	std::array<btcnew::endpoint, 8> target;
	std::fill (target.begin (), target.end (), btcnew::endpoint (boost::asio::ip::address_v6::loopback (), 10000));
	system.nodes[0]->network.random_fill (target);
	ASSERT_TRUE (std::all_of (target.begin (), target.end (), [] (btcnew::endpoint const & endpoint_a) { return endpoint_a == btcnew::endpoint (boost::asio::ip::address_v6::any (), 0); }));
}
...
TEST (channels, fill_random_full)
{
	...
	{
		system.nodes[0]->network.udp_channels.insert (btcnew::endpoint (boost::asio::ip::address_v6::loopback (), i), 0);
	}
	std::array<btcnew::endpoint, 8> target;
	std::fill (target.begin (), target.end (), btcnew::endpoint (boost::asio::ip::address_v6::loopback (), 10000));
	system.nodes[0]->network.random_fill (target);
	ASSERT_TRUE (std::none_of (target.begin (), target.end (), [] (btcnew::endpoint const & endpoint_a) { return endpoint_a == btcnew::endpoint (boost::asio::ip::address_v6::loopback (), 10000); }));
}
...
TEST (channels, fill_random_part)
{
	...
	{
		system.nodes[0]->network.udp_channels.insert (btcnew::endpoint (boost::asio::ip::address_v6::loopback (), i + 1), 0);
	}
	std::fill (target.begin (), target.end (), btcnew::endpoint (boost::asio::ip::address_v6::loopback (), 10000));
	system.nodes[0]->network.random_fill (target);
	ASSERT_TRUE (std::none_of (target.begin (), target.begin () + half, [] (btcnew::endpoint const & endpoint_a) { return endpoint_a == btcnew::endpoint (boost::asio::ip::address_v6::loopback (), 10000); }));
	ASSERT_TRUE (std::none_of (target.begin (), target.begin () + half, [] (btcnew::endpoint const & endpoint_a) { return endpoint_a == btcnew::endpoint (boost::asio::ip::address_v6::loopback (), 0); }));
	ASSERT_TRUE (std::all_of (target.begin () + half, target.end (), [] (btcnew::endpoint const & endpoint_a) { return endpoint_a == btcnew::endpoint (boost::asio::ip::address_v6::any (), 0); }));
}
...
TEST (peer_container, list_fanout)
{
	...
	{
		ASSERT_NE (nullptr, system.nodes[0]->network.udp_channels.insert (btcnew::endpoint (boost::asio::ip::address_v6::loopback (), 10000 + i), system.nodes[0]->network_params.protocol.protocol_version));
	}
...
TEST (peer_container, reachout)
{
	...
	btcnew::endpoint endpoint1 (boost::asio::ip::address_v6::loopback (), 24001);
...
TEST (peer_container, depeer)
{
	...
	btcnew::message_buffer buffer = { bytes->data (), bytes->size (), endpoint0 };
	system.nodes[0]->network.udp_channels.receive_action (&buffer);
	ASSERT_EQ (1, system.nodes[0]->stats.count (btcnew::stat::type::udp, btcnew::stat::detail::outdated_version));
}
