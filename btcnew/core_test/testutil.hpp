...
class keypair;
class public_key;
extern btcnew::keypair const & zero_key;
extern btcnew::keypair const & test_genesis_key;
extern std::string const & btcnew_test_genesis;
extern std::string const & genesis_block;
extern btcnew::public_key const & btcnew_test_account;
extern btcnew::public_key const & genesis_account;
extern btcnew::public_key const & burn_account;
extern btcnew::uint128_t const & genesis_amount;
...
namespace util
{
	...
	public:
		...
		{
			btcnew::timer<UNIT> timer (btcnew::timer_state::started);
			bool error = true;
