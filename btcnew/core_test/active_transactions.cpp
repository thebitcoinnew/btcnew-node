...
TEST (active_transactions, adjusted_difficulty_priority)
{
	...
	auto send1 (std::make_shared<btcnew::state_block> (btcnew::test_genesis_key.pub, genesis.hash (), btcnew::test_genesis_key.pub, btcnew::genesis_amount - 10 * btcnew::btcnew_ratio, key1.pub, btcnew::test_genesis_key.prv, btcnew::test_genesis_key.pub, *system.work.generate (genesis.hash ())));
	auto send2 (std::make_shared<btcnew::state_block> (btcnew::test_genesis_key.pub, send1->hash (), btcnew::test_genesis_key.pub, btcnew::genesis_amount - 20 * btcnew::btcnew_ratio, key2.pub, btcnew::test_genesis_key.prv, btcnew::test_genesis_key.pub, *system.work.generate (send1->hash ())));
	auto open1 (std::make_shared<btcnew::state_block> (key1.pub, 0, key1.pub, 10 * btcnew::btcnew_ratio, send1->hash (), key1.prv, key1.pub, *system.work.generate (key1.pub)));
	auto open2 (std::make_shared<btcnew::state_block> (key2.pub, 0, key2.pub, 10 * btcnew::btcnew_ratio, send2->hash (), key2.prv, key2.pub, *system.work.generate (key2.pub)));
	...
	{
		btcnew::lock_guard<std::mutex> active_guard (node1.active.mutex);
	...
	{
		system.deadline_set (10s);
		btcnew::unique_lock<std::mutex> active_lock (node1.active.mutex);
	...
	auto send3 (std::make_shared<btcnew::state_block> (btcnew::test_genesis_key.pub, send2->hash (), btcnew::test_genesis_key.pub, 9 * btcnew::btcnew_ratio, key3.pub, btcnew::test_genesis_key.prv, btcnew::test_genesis_key.pub, *system.work.generate (send2->hash (), btcnew::difficulty::from_multiplier (1500, node1.network_params.network.publish_threshold))));
	auto send4 (std::make_shared<btcnew::state_block> (btcnew::test_genesis_key.pub, send3->hash (), btcnew::test_genesis_key.pub, 8 * btcnew::btcnew_ratio, key3.pub, btcnew::test_genesis_key.prv, btcnew::test_genesis_key.pub, *system.work.generate (send3->hash (), btcnew::difficulty::from_multiplier (1500, node1.network_params.network.publish_threshold))));
	auto send5 (std::make_shared<btcnew::state_block> (key1.pub, open1->hash (), key1.pub, 9 * btcnew::btcnew_ratio, key3.pub, key1.prv, key1.pub, *system.work.generate (open1->hash (), btcnew::difficulty::from_multiplier (100, node1.network_params.network.publish_threshold))));
	auto send6 (std::make_shared<btcnew::state_block> (key1.pub, send5->hash (), key1.pub, 8 * btcnew::btcnew_ratio, key3.pub, key1.prv, key1.pub, *system.work.generate (send5->hash (), btcnew::difficulty::from_multiplier (100, node1.network_params.network.publish_threshold))));
	auto send7 (std::make_shared<btcnew::state_block> (key2.pub, open2->hash (), key2.pub, 9 * btcnew::btcnew_ratio, key3.pub, key2.prv, key2.pub, *system.work.generate (open2->hash (), btcnew::difficulty::from_multiplier (500, node1.network_params.network.publish_threshold))));
	auto send8 (std::make_shared<btcnew::state_block> (key2.pub, send7->hash (), key2.pub, 8 * btcnew::btcnew_ratio, key3.pub, key2.prv, key2.pub, *system.work.generate (send7->hash (), btcnew::difficulty::from_multiplier (500, node1.network_params.network.publish_threshold))));
...
TEST (active_transactions, adjusted_difficulty_overflow_max)
{
...

	{
		...
		auto modify_difficulty = [& roots = node1.active.roots](auto & existing_root) {
			roots.modify (existing_root, [](btcnew::conflict_info & info_a) {
...
TEST (active_transactions, adjusted_difficulty_overflow_min)
{
	...
	auto open1 (std::make_shared<btcnew::state_block> (key1.pub, 0, key1.pub, 10 * btcnew::btcnew_ratio, send1->hash (), key1.prv, key1.pub, *system.work.generate (key1.pub)));
	auto open2 (std::make_shared<btcnew::state_block> (key2.pub, 0, key2.pub, 10 * btcnew::btcnew_ratio, send2->hash (), key2.prv, key2.pub, *system.work.generate (key2.pub)));
	auto send3 (std::make_shared<btcnew::state_block> (key2.pub, open2->hash (), key2.pub, 9 * btcnew::btcnew_ratio, key3.pub, key2.prv, key2.pub, *system.work.generate (open2->hash ())));
	node1.process_active (send1); // genesis
	node1.process_active (send2); // genesis
	node1.process_active (open1); // key1
	node1.process_active (open2); // key2
...
TEST (active_transactions, keep_local)
{
	...
	btcnew::keypair key1, key2, key3, key4, key5, key6;
	wallet.insert_adhoc (btcnew::test_genesis_key.prv);
	auto send1 (wallet.send_action (btcnew::test_genesis_key.pub, key1.pub, node.config.receive_minimum.number ()));
	auto send2 (wallet.send_action (btcnew::test_genesis_key.pub, key2.pub, node.config.receive_minimum.number ()));
	auto send3 (wallet.send_action (btcnew::test_genesis_key.pub, key3.pub, node.config.receive_minimum.number ()));
	auto send4 (wallet.send_action (btcnew::test_genesis_key.pub, key4.pub, node.config.receive_minimum.number ()));
	auto send5 (wallet.send_action (btcnew::test_genesis_key.pub, key5.pub, node.config.receive_minimum.number ()));
	auto send6 (wallet.send_action (btcnew::test_genesis_key.pub, key6.pub, node.config.receive_minimum.number ()));
	system.deadline_set (10s);
	...
	{
		btcnew::lock_guard<std::mutex> active_guard (node.active.mutex);
	...
	auto open1 (std::make_shared<btcnew::state_block> (key1.pub, 0, key1.pub, node.config.receive_minimum.number (), send1->hash (), key1.prv, key1.pub, *system.work.generate (key1.pub)));
	node.process_active (open1);
	node.active.start (open1);
	auto open2 (std::make_shared<btcnew::state_block> (key2.pub, 0, key2.pub, node.config.receive_minimum.number (), send2->hash (), key2.prv, key2.pub, *system.work.generate (key2.pub)));
	node.process_active (open2);
	node.active.start (open2);
	auto open3 (std::make_shared<btcnew::state_block> (key3.pub, 0, key3.pub, node.config.receive_minimum.number (), send3->hash (), key3.prv, key3.pub, *system.work.generate (key3.pub)));
...
TEST (active_transactions, prioritize_chains)
{
	...
	auto send1 (std::make_shared<btcnew::state_block> (btcnew::test_genesis_key.pub, genesis.hash (), btcnew::test_genesis_key.pub, btcnew::genesis_amount - 10 * btcnew::btcnew_ratio, key1.pub, btcnew::test_genesis_key.prv, btcnew::test_genesis_key.pub, *system.work.generate (genesis.hash ())));
	auto open1 (std::make_shared<btcnew::state_block> (key1.pub, 0, key1.pub, 10 * btcnew::btcnew_ratio, send1->hash (), key1.prv, key1.pub, *system.work.generate (key1.pub)));
	auto send2 (std::make_shared<btcnew::state_block> (key1.pub, open1->hash (), key1.pub, btcnew::btcnew_ratio * 9, key2.pub, key1.prv, key1.pub, *system.work.generate (open1->hash ())));
	auto send3 (std::make_shared<btcnew::state_block> (key1.pub, send2->hash (), key1.pub, btcnew::btcnew_ratio * 8, key2.pub, key1.prv, key1.pub, *system.work.generate (send2->hash ())));
	auto send4 (std::make_shared<btcnew::state_block> (key1.pub, send3->hash (), key1.pub, btcnew::btcnew_ratio * 7, key2.pub, key1.prv, key1.pub, *system.work.generate (send3->hash ())));
	auto send5 (std::make_shared<btcnew::state_block> (btcnew::test_genesis_key.pub, send1->hash (), btcnew::test_genesis_key.pub, btcnew::genesis_amount - 20 * btcnew::btcnew_ratio, key2.pub, btcnew::test_genesis_key.prv, btcnew::test_genesis_key.pub, *system.work.generate (send1->hash ())));
	auto send6 (std::make_shared<btcnew::state_block> (btcnew::test_genesis_key.pub, send5->hash (), btcnew::test_genesis_key.pub, btcnew::genesis_amount - 30 * btcnew::btcnew_ratio, key3.pub, btcnew::test_genesis_key.prv, btcnew::test_genesis_key.pub, *system.work.generate (send5->hash ())));
	auto open2 (std::make_shared<btcnew::state_block> (key2.pub, 0, key2.pub, 10 * btcnew::btcnew_ratio, send5->hash (), key2.prv, key2.pub, *system.work.generate (key2.pub, btcnew::difficulty::from_multiplier (50., node1.network_params.network.publish_threshold))));
	uint64_t difficulty1 (0);
	btcnew::work_validate (*open2, &difficulty1);
	uint64_t difficulty2 (0);
	btcnew::work_validate (*send6, &difficulty2);
...
TEST (active_transactions, inactive_votes_cache)
{
	...
	auto vote (std::make_shared<btcnew::vote> (btcnew::test_genesis_key.pub, btcnew::test_genesis_key.prv, 0, std::vector<btcnew::block_hash> (1, send->hash ())));
	...
	ASSERT_EQ (1, system.nodes[0]->stats.count (btcnew::stat::type::election, btcnew::stat::detail::vote_cached));
}
...
TEST (active_transactions, inactive_votes_cache_existing_vote)
{
	...
	btcnew::keypair key;
	auto send (std::make_shared<btcnew::send_block> (latest, key.pub, btcnew::genesis_amount - 100 * btcnew::Gbtcnew_ratio, btcnew::test_genesis_key.prv, btcnew::test_genesis_key.pub, *system.work.generate (latest)));
	auto open (std::make_shared<btcnew::state_block> (key.pub, 0, key.pub, 100 * btcnew::Gbtcnew_ratio, send->hash (), key.prv, key.pub, *system.work.generate (key.pub))); // Increase key weight
	...
	// Insert vote
	auto vote1 (std::make_shared<btcnew::vote> (key.pub, key.prv, 1, std::vector<btcnew::block_hash> (1, send->hash ())));
	node->vote_processor.vote (vote1, std::make_shared<btcnew::transport::channel_udp> (system.nodes[0]->network.udp_channels, system.nodes[0]->network.endpoint (), system.nodes[0]->network_params.protocol.protocol_version));
	system.deadline_set (5s);
	bool done (false);
	while (!done)
	{
		btcnew::unique_lock<std::mutex> active_lock (node->active.mutex);
		done = (election->last_votes.size () == 2);
		active_lock.unlock ();
		ASSERT_NO_ERROR (system.poll ());
	}
	ASSERT_EQ (1, system.nodes[0]->stats.count (btcnew::stat::type::election, btcnew::stat::detail::vote_new));
	btcnew::lock_guard<std::mutex> active_guard (node->active.mutex);
	...
	ASSERT_EQ (0, system.nodes[0]->stats.count (btcnew::stat::type::election, btcnew::stat::detail::vote_cached));
}
...
TEST (active_transactions, inactive_votes_cache_multiple_votes)
{
	...
	btcnew::block_hash latest (system.nodes[0]->latest (btcnew::test_genesis_key.pub));
	btcnew::keypair key1;
	auto send1 (std::make_shared<btcnew::send_block> (latest, key1.pub, btcnew::genesis_amount - 100 * btcnew::Gbtcnew_ratio, btcnew::test_genesis_key.prv, btcnew::test_genesis_key.pub, *system.work.generate (latest)));
	auto send2 (std::make_shared<btcnew::send_block> (send1->hash (), key1.pub, 100 * btcnew::Gbtcnew_ratio, btcnew::test_genesis_key.prv, btcnew::test_genesis_key.pub, *system.work.generate (send1->hash ()))); // Decrease genesis weight to prevent election confirmation
	auto open (std::make_shared<btcnew::state_block> (key1.pub, 0, key1.pub, 100 * btcnew::Gbtcnew_ratio, send1->hash (), key1.prv, key1.pub, *system.work.generate (key1.pub))); // Increase key1 weight
	node->block_processor.add (send1);
	node->block_processor.add (send2);
	node->block_processor.add (open);
	node->block_processor.flush ();
	// Process votes
	auto vote1 (std::make_shared<btcnew::vote> (key1.pub, key1.prv, 0, std::vector<btcnew::block_hash> (1, send1->hash ())));
	system.nodes[0]->vote_processor.vote (vote1, std::make_shared<btcnew::transport::channel_udp> (system.nodes[0]->network.udp_channels, system.nodes[0]->network.endpoint (), system.nodes[0]->network_params.protocol.protocol_version));
	auto vote2 (std::make_shared<btcnew::vote> (btcnew::test_genesis_key.pub, btcnew::test_genesis_key.prv, 0, std::vector<btcnew::block_hash> (1, send1->hash ())));
	system.nodes[0]->vote_processor.vote (vote2, std::make_shared<btcnew::transport::channel_udp> (system.nodes[0]->network.udp_channels, system.nodes[0]->network.endpoint (), system.nodes[0]->network_params.protocol.protocol_version));
	system.deadline_set (5s);
	while (true)
	{
		{
			btcnew::lock_guard<std::mutex> active_guard (system.nodes[0]->active.mutex);
	...
	ASSERT_EQ (2, system.nodes[0]->stats.count (btcnew::stat::type::election, btcnew::stat::detail::vote_cached));
}
...
TEST (active_transactions, update_difficulty)
{
	...
	auto send1 (std::make_shared<btcnew::state_block> (btcnew::test_genesis_key.pub, genesis.hash (), btcnew::test_genesis_key.pub, btcnew::genesis_amount - 100, key1.pub, btcnew::test_genesis_key.prv, btcnew::test_genesis_key.pub, *system.work.generate (genesis.hash ())));
	uint64_t difficulty1 (0);
	btcnew::work_validate (*send1, &difficulty1);
	auto send2 (std::make_shared<btcnew::state_block> (btcnew::test_genesis_key.pub, send1->hash (), btcnew::test_genesis_key.pub, btcnew::genesis_amount - 200, key1.pub, btcnew::test_genesis_key.prv, btcnew::test_genesis_key.pub, *system.work.generate (send1->hash ())));
	uint64_t difficulty2 (0);
	btcnew::work_validate (*send2, &difficulty2);
	node1.process_active (send1);
	node1.process_active (send2);
	...
	send1 = std::shared_ptr<btcnew::state_block> (builder.from (*send1).work (*work1).build (ec));
	btcnew::state_block_builder builder1;
	send2 = std::shared_ptr<btcnew::state_block> (builder1.from (*send2).work (*work2).build (ec));
	ASSERT_FALSE (ec);
	...
	while (!done)
	{
		{
			// node1
			btcnew::lock_guard<std::mutex> guard1 (node1.active.mutex);
			...
			// node2
			btcnew::lock_guard<std::mutex> guard2 (node2.active.mutex);
...
TEST (active_transactions, restart_dropped)
{
	...
	auto & node = *system.add_node (node_config);
	btcnew::genesis genesis;
	auto send1 (std::make_shared<btcnew::state_block> (btcnew::test_genesis_key.pub, genesis.hash (), btcnew::test_genesis_key.pub, btcnew::genesis_amount - btcnew::btcnew_ratio, btcnew::test_genesis_key.pub, btcnew::test_genesis_key.prv, btcnew::test_genesis_key.pub, *system.work.generate (genesis.hash ())));
	...
	uint64_t difficulty2 (0);
	btcnew::work_validate (send1->root (), work2, &difficulty2);
	ASSERT_GT (difficulty2, difficulty1);
	// Process the same block with updated work
	auto send2 (std::make_shared<btcnew::state_block> (*send1));
